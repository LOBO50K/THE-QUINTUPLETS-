...
const defaultMenu = {
 ...
 "> H̥ͦe̥ͦl̥ͦl̥ͦo̥ͦ *%name* M̥ͦy̥ͦ N̥ͦḁͦm̥ͦe̥ͦ i̥ͦs̥ͦ *nakano*, %greeting "

 ╭────═[💞𝕴𝖓𝖋𝖔-𝕭𝖔𝖙💖]═─────⋆
│╭───────────────···
┴│> ✯ *M͙o͙d͙o͙* : Público
✩│> ✯ *B͙a͙i͙l͙e͙y͙s͙* : Multi Device
✩│> ✯ *T͙i͙e͙m͙p͙o͙ a͙c͙t͙i͙v͙o͙* : %muptime
┬│> ✯ *U͙s͙u͙a͙r͙i͙o͙s͙* : %totalreg
│╰────────────────···
╰───────────═┅═──────────
%readmore
╭────═[💌𝕴𝖓𝖋𝖔-𝖀𝖘𝖊𝖗💘]═─────⋆
│╭───────────────···
┴│> ✯ *[̲̅N̲̅][̲̅o̲̅][̲̅m̲̅][̲̅b̲̅][̲̅r̲̅][̲̅e̲̅]* : %name
✩│> ✯ *[̲̅Z̲̅][̲̅e̲̅][̲̅n̲̅][̲̅i̲̅][̲̅s̲̅]* : %limit
✩│> ✯ *[̲̅N̲̅][̲̅i̲̅][̲̅v̲̅][̲̅e̲̅][̲̅l̲̅]* : %level
┬│> ✯ *[̲̅X̲̅][̲̅P̲̅]* : %totalexp
│╰────────────────···
╰───────────═┅═──────────
%readmore
